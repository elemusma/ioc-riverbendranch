...
echo '<section class="position-relative z-3 bg-attachment pb-5" style="background:url(' . wp_get_attachment_image_url(568,'full') . ');background-size:cover;background-attachment:fixed;">';
