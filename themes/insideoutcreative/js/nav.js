...
// let triangle01 = document.querySelector('.triangle-01');
// let triangle02 = document.querySelector('.triangle-02');
...
function parallaxEffect() {
    ...
    // triangle01.classList.add('position-fixed');
    // triangle01.classList.remove('position-absolute');

    // triangle01.setAttribute('style', `top:${secondaryNav.offsetHeight}px;z-index:11;`);
    // triangle02.setAttribute('style', `top:${secondaryNav.offsetHeight}px;z-index:11;`);

    // triangle02.classList.add('position-fixed');
    // triangle02.classList.remove('position-absolute');
