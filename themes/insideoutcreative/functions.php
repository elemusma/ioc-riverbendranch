...
function riverbendranch_stylesheets() {
...
// wp_enqueue_style('liana', '//use.typekit.net/bls8brt.css');
wp_enqueue_style('bodoni', '//use.typekit.net/cxm1qpl.css');
...
add_action('wp_enqueue_scripts', 'riverbendranch_stylesheets');
// for footer
...
add_action('get_footer', 'riverbendranch_stylesheets_footer');
...
add_action('after_setup_theme', 'riverbendranch_menus');
